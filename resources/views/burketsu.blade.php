...
<div class="bg-[#FDF8F4] min-h-screen font-sans">
    ...
    <section class="relative w-full h-[400px] md:h-[450px] flex items-center bg-[#FDF8F4] overflow-hidden">
        <div class="absolute inset-0">
            <img src="{{ asset('images/burketsu.jpg') }}" loading="lazy" class="w-full h-full object-cover object-left md:object-center bg-gray-400">
        ...
        <div class="relative z-10 w-full max-w-6xl mx-auto px-6 flex justify-end">
            <div class="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left md:pl-8">
                ...
                <h1 class="text-4xl md:text-5xl font-extrabold text-[#5A3D2B] mb-4">Burketsu</h1>
                <p class="text-sm font-medium text-[#5A3D2B]/80">Jam Buka: Pukul 10.00-04.00 WIB</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#6B4C3A] py-16 px-6">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div class="w-full h-64 md:h-80 bg-gray-300 rounded-2xl overflow-hidden shadow-xl border-4 border-[#8C6C54]/30">
                <img src="images/burketsu.jpg" loading="lazy" class="w-full h-full object-cover">
            </div>
            ...
            <div class="w-full h-64 md:h-80 bg-gray-300 rounded-2xl overflow-hidden shadow-xl border-4 border-[#8C6C54]/30">
                <img src="{{ asset('images/burketsu.jpg') }}" loading="lazy" class="w-full h-full object-cover">
            </div>
            ...
            <div class="text-[#FDF8F4]">
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-sm leading-relaxed text-[#FDF8F4]/90">Depan Anhesa Gym, Jl. Kolonel Hardiyanto, Rt 3 rw 4, Dukuh Mbanaran, Sekaran, Kota Semarang, Jawa Tengah 50229</p>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-[#FDF8F4]/90">0812-4999-8558</p>
                    </div>
                </div>
                ...
                <div class="w-full h-48 md:h-56 bg-gray-200 rounded-2xl overflow-hidden relative shadow-lg border border-[#FDF8F4]/20 mt-6">
                    <iframe src="https://maps.google.com/maps?q=BURKETSU+Gunungpati&t=&z=15&ie=UTF8&iwloc=&output=embed" class="absolute inset-0 w-full h-full" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
