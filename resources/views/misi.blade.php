...
<div class="bg-[#FDF8F4] min-h-screen text-[#5A3D2B] font-sans pb-10 scroll-smooth">
    ...
    <section class="relative w-full h-[250px] flex items-center justify-center overflow-hidden bg-[#D5C3B3]">
        <img src="" alt="Misi Background" loading="lazy" class="absolute inset-0 w-full h-full object-cover">
    ...
    <main class="max-w-6xl mx-auto px-6 py-16 flex flex-col md:flex-row gap-12">
        
        <aside class="md:w-1/3 hidden md:block">
            <div class="sticky top-24 flex flex-col gap-6 text-[22px] font-extrabold text-[#5A3D2B] text-right pr-4">
                <a href="#misi-harian" class="hover:text-[#B57A4E] transition duration-200">Misi Harian</a>
                <a href="#ramadhan-kareem" class="hover:text-[#B57A4E] transition duration-200">Ramadhan Kareem</a>
                <a href="#traveller" class="hover:text-[#B57A4E] transition duration-200">The Warmindo Traveller</a>
                <a href="#reviewer" class="hover:text-[#B57A4E] transition duration-200">Reviewer Handal</a>
            </div>
        </aside>

        <div class="md:w-2/3 space-y-10">

            <section id="misi-harian" class="scroll-mt-24">
                <div class="bg-[#E2D4C8] p-6 md:p-8 rounded-2xl shadow-md border border-[#D5C3B3]/50">
                    <h2 class="text-2xl font-bold text-[#5A3D2B] mb-5">Misi Harian</h2>
                    <div class="space-y-4">
                        <div class="bg-[#F5ECE5] rounded-xl p-4 flex justify-between items-center shadow-sm cursor-pointer hover:shadow-md transition">
                            <div>
                                <h3 class="font-bold text-[#5A3D2B] text-sm md:text-base mb-1">Check In Harian</h3>
                            ...
                            <svg class="w-6 h-6 text-[#8C6C54]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                        </div>
                        <div class="bg-[#F5ECE5] rounded-xl p-4 flex justify-between items-center shadow-sm cursor-pointer hover:shadow-md transition">
                            <div>
                                <h3 class="font-bold text-[#5A3D2B] text-sm md:text-base mb-1">Misi Tambahan</h3>
                                <div class="flex items-center gap-1.5 text-xs font-bold text-[#8C6C54]">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2A10 10 0 1022 12 10.011 10.011 0 0012 2zm0 18a8 8 0 118-8 8.009 8.009 0 01-8 8z"/><path d="M12 6a6 6 0 106 6 6.007 6.007 0 00-6-6zm0 10a4 4 0 114-4 4.005 4.005 0 01-4 4z"/></svg>
                                    25
                                </div>
            ...
            <section id="ramadhan-kareem" class="scroll-mt-24">
                <div class="bg-[#E2D4C8] p-6 md:p-8 rounded-2xl shadow-md border border-[#D5C3B3]/50">
                    <h2 class="text-2xl font-bold text-[#5A3D2B] mb-5">Ramadhan Kareem</h2>
                    <div class="space-y-4">
                        <div class="bg-[#F5ECE5] rounded-xl p-4 flex justify-between items-center shadow-sm cursor-pointer hover:shadow-md transition">
                            <div>
                                <h3 class="font-bold text-[#5A3D2B] text-sm md:text-base mb-1">Check In Sahur</h3>
                                <div class="flex items-center gap-1.5 text-xs font-bold text-[#8C6C54]">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2A10 10 0 1022 12 10.011 10.011 0 0012 2zm0 18a8 8 0 118-8 8.009 8.009 0 01-8 8z"/><path d="M12 6a6 6 0 106 6 6.007 6.007 0 00-6-6zm0 10a4 4 0 114-4 4.005 4.005 0 01-4 4z"/></svg>
                                    50
                                </div>
                        ...
                        <div class="bg-[#F5ECE5] rounded-xl p-4 flex justify-between items-center shadow-sm cursor-pointer hover:shadow-md transition">
                            <div>
                                <h3 class="font-bold text-[#5A3D2B] text-sm md:text-base mb-1">Bukber Bareng</h3>
                                <div class="flex items-center gap-1.5 text-xs font-bold text-[#8C6C54]">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2A10 10 0 1022 12 10.011 10.011 0 0012 2zm0 18a8 8 0 118-8 8.009 8.009 0 01-8 8z"/><path d="M12 6a6 6 0 106 6 6.007 6.007 0 00-6-6zm0 10a4 4 0 114-4 4.005 4.005 0 01-4 4z"/></svg>
                                    100
                                </div>
            ...
            <section id="traveller" class="scroll-mt-24">
                <div class="bg-[#E2D4C8] p-6 md:p-8 rounded-2xl shadow-md border border-[#D5C3B3]/50">
                    <h2 class="text-2xl font-bold text-[#5A3D2B] mb-5">Traveller</h2>
                    <div class="space-y-4">
                        <div class="bg-[#F5ECE5] rounded-xl p-4 flex justify-between items-center shadow-sm cursor-pointer hover:shadow-md transition">
                            <div>
                                <h3 class="font-bold text-[#5A3D2B] text-sm md:text-base mb-1">Kunjungi 3 Mitra</h3>
                                <div class="flex items-center gap-1.5 text-xs font-bold text-[#8C6C54]">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2A10 10 0 1022 12 10.011 10.011 0 0012 2zm0 18a8 8 0 118-8 8.009 8.009 0 01-8 8z"/><path d="M12 6a6 6 0 106 6 6.007 6.007 0 00-6-6zm0 10a4 4 0 114-4 4.005 4.005 0 01-4 4z"/></svg>
                                    150
                                </div>
            ...
            <section id="reviewer" class="scroll-mt-24">
                <div class="bg-[#E2D4C8] p-6 md:p-8 rounded-2xl shadow-md border border-[#D5C3B3]/50">
                    <h2 class="text-2xl font-bold text-[#5A3D2B] mb-5">Reviewer</h2>
                    <div class="space-y-4">
                        <div class="bg-[#F5ECE5] rounded-xl p-4 flex justify-between items-center shadow-sm cursor-pointer hover:shadow-md transition">
                            <div>
                                <h3 class="font-bold text-[#5A3D2B] text-sm md:text-base mb-1">Berikan 5 Ulasan</h3>
                                <div class="flex items-center gap-1.5 text-xs font-bold text-[#8C6C54]">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2A10 10 0 1022 12 10.011 10.011 0 0012 2zm0 18a8 8 0 118-8 8.009 8.009 0 01-8 8z"/><path d="M12 6a6 6 0 106 6 6.007 6.007 0 00-6-6zm0 10a4 4 0 114-4 4.005 4.005 0 01-4 4z"/></svg>
                                    200
                                </div>
    ...
    <section class="mt-12 py-16 bg-[#F6EBE1] border-t border-[#EADDCF]">
        <<div class="mt-20 max-w-3xl mx-auto bg-white p-8 md:p-10 rounded-[2rem] shadow-xl border border-[#D5C3B3]/40 relative overflow-hidden">
                <div class="absolute -top-10 -right-10 w-32 h-32 bg-[#FCECDD] rounded-full blur-3xl opacity-60 pointer-events-none"></div>
                <div class="absolute -bottom-10 -left-10 w-32 h-32 bg-[#E2D4C8] rounded-full blur-3xl opacity-60 pointer-events-none"></div>
                ...
                <div class="relative z-10">
                    ...
                    <form action="{{ route('review.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="umkm_id" required class="w-full appearance-none border border-[#D5C3B3] bg-[#FDF8F4] rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-[#8C6C54] text-[#5A3D2B] cursor-pointer">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between gap-1 sm:gap-2">
                                ...
                                <label class="cursor-pointer flex-1">
                                    ...
                                    <div class="w-full aspect-square flex items-center justify-center rounded-lg border border-[#D5C3B3] bg-[#FDF8F4] text-[#5A3D2B] font-bold text-xs md:text-sm hover:bg-[#EADDCF] peer-checked:bg-[#8C6C54] peer-checked:text-white peer-checked:border-[#8C6C54] peer-checked:shadow-md transition-all duration-200">
                                        {{ $i }}
                                    </div>
                                </label>
                                @endfor
                            </div>
                            <div class="flex justify-between text-[10px] md:text-xs text-[#5A3D2B]/60 mt-1.5 font-semibold px-1">
                        ...
                        <div>
                            ...
                            <textarea name="comment" rows="4" required placeholder="Ceritain pengalaman asikmu nongkrong di sini..." class="w-full border border-[#D5C3B3] bg-[#FDF8F4] rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#8C6C54] text-[#5A3D2B] placeholder-[#5A3D2B]/40 resize-none"></textarea>
                        </div>

                        <button type="submit" class="w-full bg-[#8C6C54] hover:bg-[#5A3D2B] text-white font-bold py-3.5 rounded-xl transition-colors shadow-lg shadow-[#8C6C54]/30 flex items-center justify-center gap-2 tracking-wide">
