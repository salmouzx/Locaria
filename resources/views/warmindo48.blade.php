...
<div class="bg-[#FDF8F4] min-h-screen font-sans">
    <section class="relative w-full h-[400px] md:h-[450px] flex items-center bg-[#FDF8F4]">
        <div class="absolute inset-0">
            <img src="images/warmindo48.jpg" loading="lazy" class="w-full h-full object-cover bg-gray-400">
        ...
        <div class="relative z-10 w-full max-w-6xl mx-auto px-6 flex justify-end">
            <div class="text-right md:w-1/2">
                ...
                <h1 class="text-4xl md:text-5xl font-extrabold text-[#5A3D2B] mb-4">Warmindo 48 UNNES</h1>
            ...
            <div class="text-[#FDF8F4]">
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-sm leading-relaxed text-[#FDF8F4]/90">Jl. Raya Banaran, Sekaran, Kec. Gn. Pati, Kota Semarang, Jawa Tengah 50229</p>
                    </div>
