...
<div class="bg-[#FDF8F4] min-h-screen text-[#5A3D2B] font-sans">
    ...
    <section class="relative w-full h-[500px] md:h-[600px] flex items-center">
        <img src="images/bg.jpg" alt="Hero Background" loading="lazy" class="absolute inset-0 w-full h-full object-cover bg-gray-700">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 w-full">
            <div class="max-w-2xl text-white">
                ...
                <a href="#tongkrongan" class="inline-block bg-[#FDF8F4] text-[#5A3D2B] font-bold px-6 py-2.5 rounded-full hover:bg-[#E8D5C4] transition shadow-md">
                    Lihat Tongkrongan
                </a>
            </div>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div class="text-[#FDF8F4]">
                ...
                <p class="text-sm md:text-base leading-relaxed text-[#FDF8F4]/90">
                    Locaria hadir untuk membantu anda mendapatkan pengalaman terbaik dalam menjelajahi UMKM sekitar. Nikmati berbagai promo menarik dan eksklusif. Kumpulkan juga berbagai poin reward disetiap transaksi.
                    <br><br>
                    Jadikan jajan lokal menjadi lebih seru dan menguntungkan!
                </p>
            </div>
            <div class="relative">
                <div class="w-full h-64 md:h-80 bg-gray-300 rounded-3xl overflow-hidden shadow-xl border-4 border-[#8C6C54]/50">
    ...
    <section id="tongkrongan" class="bg-[#F4EAE2] py-20 px-6 relative overflow-hidden z-0">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-center gap-4 relative">
                <button class="w-10 h-10 rounded-full bg-[#8C6C54] text-white flex items-center justify-center hover:bg-[#5A3D2B] transition shadow-md z-10 shrink-0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 flex-1">
                    ...
                    <a href="#" class="relative w-full h-56 md:h-64 rounded-xl overflow-hidden group shadow-lg">
                        <img src="{{ asset('images/' . $tongkrongan['gambar']) }}" loading="lazy" class="absolute inset-0 w-full h-full object-cover bg-gray-400">
                        <div class="absolute inset-0 bg-gradient-to-t from-[#5A3D2B]/90 via-[#5A3D2B]/40 to-transparent"></div>
                        
                        <div class="absolute top-3 right-3 bg-black/50 backdrop-blur-sm text-yellow-400 text-xs font-bold px-2 py-1 rounded flex items-center gap-1">
                            {{ $tongkrongan['rating'] }} 
                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                        </div>
                        
                        <div class="absolute bottom-4 left-0 w-full text-center text-white px-2 group-hover:translate-y-[-5px] transition">
    ...
    <section class="py-20 px-6 bg-[#FDF8F4]">
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-10">
                ...
                <p class="text-sm text-[#5A3D2B]/80">Nikmati promo gila yang membuat dompet Anda bahagia dan perut kenyang</p>
            </div>
            ...
            <div class="bg-[#EADDCF] border-2 border-dashed border-[#8C6C54] rounded-xl p-8 md:p-12 relative">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                    <a href="{{ route('promo') ?? '#' }}">
                        <div class="flex flex-col items-center">
                            <div class="w-full aspect-square bg-gray-400 border-4 border-white shadow-sm mb-3">
                                <img src="images/warmindo-online.jpg" loading="lazy" class="w-full h-full object-cover">
                            </div>
                            <p class="font-bold text-[#5A3D2B]">Warmindo Online</p>
                        </div>
                    </a>
                    <a href="{{ route('promo') ?? '#' }}">
                        <div class="flex flex-col items-center">
                            <div class="w-full aspect-square bg-gray-400 border-4 border-white shadow-sm mb-3">
                                <img src="images/boim.jpg" loading="lazy" class="w-full h-full object-cover">
                            </div>
                            <p class="font-bold text-[#5A3D2B]">Burjo Boim Banaran</p>
                        </div>
                    </a>
                    <a href="{{ route('promo') ?? '#' }}">
                        <div class="flex flex-col items-center">
                    ...
                    <a href="{{ route('promo') ?? '#' }}">
                        <div class="flex flex-col items-center">
                            <div class="w-full aspect-square bg-gray-400 border-4 border-white shadow-sm mb-3">
                                <img src="images/asep2.jpg" loading="lazy" class="w-full h-full object-cover">
                            </div>
                            <p class="font-bold text-[#5A3D2B]">Burjo Asep 2</p>
                        </div>
                    </a>
                </div>

                <div class="text-center">
                    <a href="{{ route('promo') ?? '#' }}" class="inline-block bg-[#8C6C54] text-white font-bold px-8 py-2.5 rounded-full hover:bg-[#5A3D2B] transition shadow-md text-sm">
                        Selengkapnya >
                    </a>
                </div>
            </div>
