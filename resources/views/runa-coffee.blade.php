...
<div class="bg-[#FDF8F4] min-h-screen font-sans">
    <section class="relative w-full h-[400px] md:h-[450px] flex items-center bg-[#FDF8F4]">
        <div class="absolute inset-0">
            <img src="images/runa-coffee.jpg" loading="lazy" class="w-full h-full object-cover bg-gray-400">
        ...
        <div class="relative z-10 w-full max-w-6xl mx-auto px-6 flex justify-end">
            <div class="text-right md:w-1/2">
                ...
                <h1 class="text-4xl md:text-5xl font-extrabold text-[#5A3D2B] mb-4">Runa Coffee</h1>
                <p class="text-sm font-bold text-[#5A3D2B]/80">Jam Buka: Pukul 10.00 - 23.30 WIB</p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#6B4C3A] py-16 px-6">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div class="w-full h-64 md:h-80 bg-gray-300 rounded-2xl overflow-hidden shadow-xl border-4 border-[#8C6C54]/30">
                <img src="images/runa.jpg" loading="lazy" class="w-full h-full object-cover">
            </div>
            <div class="text-[#FDF8F4]">
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-sm leading-relaxed text-[#FDF8F4]/90">Jl. Manggis Raya No.105, Sekaran, Kec. Gn. Pati, Kota Semarang, Jawa Tengah 50229</p>
                    </div>
                ...
                <div class="w-full h-40 bg-gray-200 rounded-xl overflow-hidden relative shadow-inner">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center text-[#5A3D2B] font-bold text-sm bg-white/40 backdrop-blur-sm">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.6036695222874!2d110.39117101076089!3d-7.0557683691149755!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e708b007ac3f82b%3A0x107eba9d28e14bc5!2sRuna%20Coffee!5e0!3m2!1sen!2sid!4v1774522321798!5m2!1sen!2sid" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
